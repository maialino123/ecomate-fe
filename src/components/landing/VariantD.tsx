...
const IMAGES = {
  ...
  heroOverlay:
    "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?q=80&w=3840&auto=format&fit=crop", // Smart home control panel
  heroLayer2:
    "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?q=80&w=3840&auto=format&fit=crop", // Elegant home interior
  heroLayer3:
    "https://images.unsplash.com/photo-1600607687644-aac4c3eac7f4?q=80&w=3840&auto=format&fit=crop", // Warm family space
  feature1:
    "https://images.unsplash.com/photo-1556909212-d5b604d0c90d?q=80&w=3540&auto=format&fit=crop", // Modern kitchen interior
  feature2:
    "https://images.unsplash.com/photo-1617104678098-ab8e2a3e8c66?q=80&w=3540&auto=format&fit=crop", // Bedroom with warm lighting
  impact:
    "https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?q=80&w=3540&auto=format&fit=crop", // Modern family home
  testimonial:
    "https://images.unsplash.com/photo-1600607687644-aac4c3eac7f4?q=80&w=3540&auto=format&fit=crop", // Cozy home interior
...
export default function VariantD({ variant }: VariantProps) {
  ...
  const handleSubmit = useCallback(
    ...
    [email, variant]
  ); // Only recreate when email or variant changes
      ...
      >
        ...
        <div className="absolute inset-0 z-10 pointer-events-none flex items-center justify-center">
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(251, 191, 36, 0.35) 0%, rgba(245, 158, 11, 0.18) 35%, transparent 65%)",
              filter: "blur(40px)",
            }}
            animate={{
              scale: [1, 1.15, 1],
              ...
              <div className="text-center lg:text-left space-y-6 md:space-y-8">
                ...
                >
                  ...
                  <span className="font-bold text-white">
                    Được tin cậy bởi{" "}
                    <span className="text-amber-300">15,000+</span> gia đình
                    Việt
                  </span>
                </motion.div>
                  ...
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-snug md:leading-tight">
                    <div
                      ...
                      style={{
                        color: "#ffffff",
                        textShadow:
                          "0 4px 20px rgba(0,0,0,0.5), 0 8px 40px rgba(0,0,0,0.3), 0 0 60px rgba(251, 191, 36, 0.3)",
                    ...
                    <div
                      className="hero-title-word inline-block relative"
                      style={{
                        background:
                    ...
                    >
                      ...
                      <motion.div
                        ...
                        style={{
                          background:
                            "linear-gradient(90deg, #fbbf24, #f59e0b, #fb923c)",
                        }}
                        animate={{
                          scaleX: [0, 1],
                          opacity: [0, 1],
                ...
                >
                  ...
                  và tiện ích gia dụng hiện đại, biến không gian sống thành nơi
                  an lạc và đầy cảm hứng
                </p>
                ...
                <div className="grid grid-cols-2 gap-4 mt-8">
                  {FLOATING_FEATURES.map((feature, index) => (
                    ...
                    >
                      ...
                      <h3 className="text-sm sm:text-base font-bold mb-2 leading-snug">
                        {feature.title}
                      </h3>
...
function MagneticCTA({ onSubmit, email, setEmail }: any) {
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 backdrop-blur-md p-2 rounded-xl sm:rounded-2xl shadow-2xl border border-primary-100/50">
        <Input
          type="email"
          value={email}
        ...
        <motion.div
          ...
          style={{
            x:
              typeof window !== "undefined" && window.innerWidth >= 768 ? x : 0,
            y:
              typeof window !== "undefined" && window.innerWidth >= 768 ? y : 0,
          }}
          className="relative"
          onClick={handleClick}
        >
      ...
      <p
        className="text-xs sm:text-sm mt-4 font-medium text-center leading-relaxed"
        style={{ color: "#e5e7eb", textShadow: "0 1px 3px rgba(0,0,0,0.5)" }}
      >
    ...
    >
      {stats.map((stat, index) => (
        ...
        >
          ...
          <div className="text-xs sm:text-sm text-slate-700 mt-2 leading-snug">
            {stat.label}
          </div>
        </motion.div>
      ))}
  ...
  const features = [
    {
      ...
      description:
        "Giải pháp IoT hiện đại giúp điều khiển ánh sáng, nhiệt độ, an ninh từ xa. Tiết kiệm điện năng và nâng cao trải nghiệm sống.",
    },
    {
      icon: "🛋️",
      title: "Phòng Khách Hiện Đại",
      description:
        "Tủ trang trí thông minh, kệ TV đa năng, đèn LED điều chỉnh màu sắc. Biến phòng khách thành không gian tiếp khách ấn tượng.",
    },
    {
      icon: "🍳",
      title: "Bếp Tiện Nghi",
      description:
        "Thiết bị nhà bếp thông minh, giá để đồ thông minh, máy lọc nước RO. Nấu nướng dễ dàng, gian bếp gọn gàng.",
    },
    {
      icon: "🛏️",
      title: "Phòng Ngủ An Lạc",
      description:
        "Đèn ngủ cảm ứng, tủ quần áo thông minh, máy khuếch tán tinh dầu. Không gian nghỉ ngơi lý tưởng cho giấc ngủ sâu.",
    },
    {
      icon: "🚿",
      title: "Phòng Tắm Sang Trọng",
      description:
        "Vòi cảm ứng, kệ treo thông minh, gương LED hiện đại. Nâng tầm trải nghiệm thư giãn mỗi ngày.",
    },
    {
      icon: "🎨",
      title: "Phong Cách Cá Nhân",
      description:
        "Kết hợp đa dạng phong cách từ tối giản, Bắc Âu, đến hiện đại Nhật Bản. Tạo dựng không gian riêng biệt.",
    },
  ];
      ...
      <div className="container mx-auto max-w-7xl relative">
        <div className="text-center mb-12 md:mb-16 space-y-4">
          ...
          <p className="features-subtitle text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
            Từ phòng khách đến phòng ngủ, từ nhà bếp đến phòng tắm - Ecomate
...
function ImpactSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-12 md:py-20 px-4 relative overflow-hidden min-h-[500px] md:min-h-[600px] flex items-center"
    >
      ...
      <div className="container mx-auto max-w-6xl text-center relative z-10">
        <div className="space-y-8 md:space-y-12">
          ...
          <p className="impact-description text-base sm:text-lg md:text-xl max-w-2xl mx-auto text-amber-50 drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] leading-relaxed px-4 sm:px-0">
            15,000+ gia đình Việt đã tin tưởng và lựa chọn Ecomate, biến ngôi
            nhà thành không gian sống lý tưởng
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {[
              ...
              >
                <div className="text-4xl sm:text-5xl md:text-6xl mb-3 md:mb-4 drop-shadow-lg">
                  {item.icon}
                </div>
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold mb-2 text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.7)] leading-tight">
                  {item.number}
                </div>
                <div className="text-sm sm:text-base md:text-lg text-amber-50 drop-shadow-md leading-snug">
                  {item.label}
                </div>
              </div>
            ))}
  ...
  const testimonials = [
    {
      ...
      content:
        "Mua bộ kệ bếp thông minh của Ecomate, gian bếp nhà mình gọn gàng hơn hẳn. Giá cả phải chăng, chất lượng tốt, giao hàng nhanh. Rất hài lòng!",
      avatar: "👩",
    },
    {
      ...
      content:
        "Đèn LED thông minh điều khiển bằng app rất tiện. Setup dễ dàng, tiết kiệm điện đáng kể. Nhà mình giờ hiện đại hơn nhiều. Recommend!",
      avatar: "👨",
    },
    {
      ...
      content:
        "Mua máy khuếch tán tinh dầu và đèn ngủ cho phòng ngủ. Chất lượng vượt mong đợi với mức giá này. Sẽ ủng hộ Ecomate lâu dài!",
      avatar: "👩‍💼",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(134, 239, 172, 0.05) 0%, rgba(34, 197, 94, 0.05) 100%)",
        }}
      />
      ...
      <div className="relative z-10 space-y-4">
        <div className="flex items-center">
          ...
          <div>
            <div className="font-bold text-base md:text-lg text-gray-900 leading-snug">
              {testimonial.name}
            </div>
            <div className="text-xs md:text-sm text-primary-600 font-medium leading-snug">
              {testimonial.role}
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="relative z-10 space-y-6 md:space-y-10">
            ...
            <p className="cta-description text-base sm:text-lg md:text-xl max-w-2xl mx-auto leading-relaxed px-4 sm:px-0">
              Khám phá 5,000+ sản phẩm tiện ích tại Shopee Store. Mua sắm dễ
              dàng, giao hàng nhanh chóng ngay hôm nay!
            </p>
      ...
      <div className="flex flex-col sm:flex-row gap-3 bg-white/10 backdrop-blur-md p-2 rounded-2xl border border-white/20 shadow-2xl">
        ...
        >
          ...
          <Button
            type="submit"
            size="lg"
            className="px-6 sm:px-8 bg-white text-gray-900 hover:bg-gray-100 shadow-lg whitespace-nowrap relative overflow-hidden group text-sm sm:text-base leading-normal w-full sm:w-auto"
          >
